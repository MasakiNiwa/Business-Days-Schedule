...
- 960px 未満で1カラムに折り返し、ルール一覧はカレンダーの下に置く
...
狭い画面ではツールチップが使えないため、チップの文字を省略せず折り返してセルを伸ばす。
...
| 表示 | 休業日・祝日・補正マークがマークアップに現れること／ルール名の HTML がエスケープされること |
